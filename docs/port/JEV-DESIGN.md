...
3. **Which critics to invoke — accept additional recommendations; defer omission of required critics.**
   - **Current:** domain/prod-bound/docs paths and labels choose specialists; adversarial critic always runs: [feature.md:78](../../bootstrap/commands/feature.md#L78), [:86](../../bootstrap/commands/feature.md#L86). Current requirements remain in [dod-checklist.md:11](../../docs/runbooks/dod-checklist.md#L11).
